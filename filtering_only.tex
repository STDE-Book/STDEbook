...
%%\input{Contents/estimation/MC1}  % Input instead of include to avoid newpage after the title
%\include{Contents/estimation/MC2}
%\include{Contents/estimation/MC3}
%\include{Contents/estimation/MC4}
%\include{Contents/estimation/MC5}
%\include{Contents/estimation/MC6}
%\include{Contents/estimation/MC7_problems}
...
\mainmatter %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\tableofcontents
\include{Contents/stochastic_processes/MC8_filtering}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Chapter: Spectral estimation
%\chapter{Spectral Estimation}
%\include{Contents/stochastic_processes/MC9_PSD}
