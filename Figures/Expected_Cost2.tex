...
ymin=0,
ymax=0.5,
ylabel=$\overline{C}_{n,G}(p)$,
legend style={draw=white!15!black,fill=white,legend cell align=left,legend pos=north east},
]
...
\addLUADEDplotcdf[color=red,thick,smooth]{0}{1}{2}{0.05}{100}{1000};
\addLUADEDplotcdf[color=cyan,thick,smooth]{0}{1}{3}{0.05}{100}{1000};
