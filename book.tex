...
\author{Jer\'onimo Arenas-Garc\'ia, Jes\'us Cid-Sueiro, Vanessa G\'omez-Verdejo, Miguel L\'azaro-Gredilla and David Ram\'irez-Garc\'ia and Emilio Parrado-Hern\'andez}
...
\input{Contents/MC1}  % Input instead of include to avoid newpage after the title
\include{Contents/MC2}
\include{Contents/MC3}
\include{Contents/MC4}
\include{Contents/MC5}
\include{Contents/MC6}
\include{Contents/MC7_problems}

% Chapter: Filtering
\include{Contents/MC8_filtering}

% Chapter: Spectral estimation
\include{Contents/MC9_PSD}

%\include{Contents/Labo_est}
